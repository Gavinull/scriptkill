...
/// app bar, see [SliverAppBar], which embeds an [AppDefultNavBar] in a sliver for use in
/// a [CustomScrollView].
///
...
///
/// If the [leading] widget is omitted, but the [AppDefultNavBar] is in a [Scaffold] with
...
///
/// This sample shows an [AppDefultNavBar] with two simple actions. The first action
...
/// See also:
///
///  * [Scaffold], which displays the [AppDefultNavBar] in its [Scaffold.appBar] slot.
///  * [SliverAppBar], which uses [AppDefultNavBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [AppDefultNavBar]
...
class AppDefultNavBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [AppDefultNavBar] will imply an appropriate widget. For example, if the [AppDefultNavBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [AppDefultNavBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [AppDefultNavBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [AppDefultNavBar]'s container
  /// changes the [AppDefultNavBar]'s size. A [SliverAppBar] in a [CustomScrollView]
  /// changes the [AppDefultNavBar]'s height when scrolled.
  ///
  ...
  @override
  _AppDefultNavBarState createState() => _AppDefultNavBarState();
}

class _AppDefultNavBarState extends State<AppDefultNavBar> {
...
/// the screen see [AppDefultNavBar], which is used in the [Scaffold.appBar] slot.
///
...
///    scrolling.
///  * [AppDefultNavBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [AppDefultNavBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
class SliverAppBar extends StatefulWidget {
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [AppDefultNavBar] will
  /// imply an appropriate widget. For example, if the [AppDefultNavBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [AppDefultNavBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// content is not scrolled under the [AppDefultNavBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [AppDefultNavBar] is being displayed over content that is scrolled under it.
  ///
